    ...
    return(
        ...
        <div className="col-md-8 offset-md-2">
            ...
            <form >
                ...
                <div className="mb-3" >
                    <label className="form-label" htmlFor="location">Origin of Message:</label>
                    <input className="form-control"type="text" name="origin" id="location" required/>
                </div >
                <div className="mb-3">
                    <label htmlFor="formFileMultiple" className="form-label">File Upload:</label>
                    <input className="form-control" type="file" id="formFileMultiple" name='file' multiple/>
                </div>
                {/* <div className="mb-3">
                ...
                <div className="mb-3" >
                    <label className="form-label" htmlFor="location">Message</label>
                    <textarea name="message" type="text" id="textarea" style={{"height": "150px"}} className="form-control" required></textarea>
                </div >
                <div className="mb-3">
